...
with DAG(
    ...
    # their heap and OOM the VM. We therefore chain the Silver jobs, the Gold join
    # and the quality gates into a single serial line (heaviest DVF job first).
    # Each Silver job still waits on its own ingested Bronze data.
