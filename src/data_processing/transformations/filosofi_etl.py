...
def _bronze_input(bucket: str, year: int, departement: str | None) -> str:
    if departement:
...
def transform(df: DataFrame) -> DataFrame:
    ...
    obs_df = (
        ...
        # GEO = "<ref>-COM-<insee>" -> strip everything up to and incl. "COM-".
...
def run(year: int, departement: str | None, bronze_bucket: str, silver_bucket: str) -> None:
